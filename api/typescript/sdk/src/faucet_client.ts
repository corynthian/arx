 ...
 */
export class FaucetClient extends ArxClient {
  faucetRequester: AxiosHttpRequest;

  /**
   * Establishes a connection to Arx node
   * @param nodeUrl A url of the Arx Node API endpoint
   ...
   * @param address Hex-encoded 16 bytes Arx account address wich mints tokens
