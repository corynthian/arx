...
export const ARX_COIN = "0x1::arx_coin::ArxCoin";
export const LUX_COIN = "0x1::lux_coin::LuxCoin";
export const NOX_COIN = "0x1::nox_coin::NoxCoin";
export const XUSD_COIN = "0x1::xusd_coin::XUSDCoin";
