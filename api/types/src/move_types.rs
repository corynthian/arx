...
use arx_types::{account_config::CORE_CODE_ADDRESS, event::EventKey, transaction::Module};
...
mod tests {
    ...
    fn test_parse_invalid_move_module_id_string() {
        ...
        assert_eq!(
            "Invalid Move module ID: Arx::Arx",
            "Arx::Arx"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid Move module ID: 0x1::Arx::Arx",
            "0x1::Arx::Arx"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
    ...
    fn test_parse_invalid_move_entry_function_id_string() {
        ...
        assert_eq!(
            "Invalid entry function ID Arx::Arx",
            "Arx::Arx"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid entry function ID 0x1::Arx::Arx::Arx",
            "0x1::Arx::Arx::Arx"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
