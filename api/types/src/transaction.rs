...
use crate::{
    Address, ArxError, EntryFunctionId, EventGuid, HashValue, HexEncodedBytes,
...
pub struct TransactionOnChainData {
    ...
    pub transaction: arx_types::transaction::Transaction,
    /// Information about the transaction
    pub info: arx_types::transaction::TransactionInfo,
    /// Events emitted by the transaction
    pub events: Vec<ContractEvent>,
    /// The accumulator root hash at this version
    pub accumulator_root_hash: arx_crypto::HashValue,
    /// Final state of resources changed by the transaction
    pub changes: arx_types::write_set::WriteSet,
}

impl From<(TransactionWithProof, arx_crypto::HashValue)> for TransactionOnChainData {
    fn from((txn, accumulator_root_hash): (TransactionWithProof, arx_crypto::HashValue)) -> Self {
        Self {
            version: txn.version,
...
impl
    From<(
        u64,
        arx_types::transaction::Transaction,
        arx_types::transaction::TransactionInfo,
        Vec<ContractEvent>,
        arx_crypto::HashValue,
        arx_types::write_set::WriteSet,
    )> for TransactionOnChainData
{
    fn from(
...
/// Enum of the different types of transactions in Arx
...
impl TryFrom<MultiEd25519Signature> for TransactionAuthenticator {
    ...
    fn try_from(value: MultiEd25519Signature) -> Result<Self, Self::Error> {
        ...
        Ok(TransactionAuthenticator::multi_ed25519(
            ...
            arx_crypto::multi_ed25519::MultiEd25519Signature::new_with_signatures_and_bitmap(
                ed25519_signatures,
