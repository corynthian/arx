...
use arx_api_types::{
    verify_module_identifier, Address, ArxErrorCode, AsConverter, IdentifierWrapper, LedgerInfo,
...
use arx_storage_interface::state_view::DbStateView;
use arx_types::{
...
impl StateApi {
    ...
    ///
    /// The Arx nodes prune account state history, via a configurable time window.
    ...
    async fn get_account_resource(
        ...
        resource_type
            ...
            .map_err(|err| {
                BasicErrorWith404::bad_request_with_code_no_info(err, ArxErrorCode::InvalidInput)
            })?;
