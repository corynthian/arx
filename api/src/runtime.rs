...
pub fn bootstrap(
    ...
    let runtime = arx_tokio_runtime::spawn_named_runtime("api".into(), None);
...
// TODO: https://github.com/arx-labs/arx-core/issues/2280
...
> {
    ...
    let contact = ContactObject::new()
        .name("Arx Labs")
        .url("https://github.com/arx-labs/arx-core");

    OpenApiService::new(apis, "Arx Node API", version.trim())
        .server("/v1")
        .description("The Arx Node API is a RESTful API for client applications to interact with the Arx blockchain.")
        .license(license)
        .contact(contact)
        .external_document("https://github.com/arx-labs/arx-core")
}
...
mod tests {
    use super::bootstrap;
    use arx_api_test_context::{new_test_context, TestContext};
    use arx_config::config::NodeConfig;
    use arx_types::chain_id::ChainId;
    ...
    // https://github.com/arx-labs/arx-core/issues/2977
    #[ignore]
    #[test]
