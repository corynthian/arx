...
use arx_config::config::ConsensusConfig;
...
use arx_infallible::{checked, Mutex};
use arx_logger::prelude::*;
#[cfg(test)]
use arx_safety_rules::ConsensusState;
use arx_safety_rules::TSafetyRules;
use arx_types::{
...
impl RoundManager {
    pub fn new(
        ...
        storage: Arc<dyn PersistentLivenessStorage>,
        onchain_config: OnChainConsensusConfig,
        round_manager_tx: channel::Sender<
