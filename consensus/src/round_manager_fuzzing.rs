...
use arx_config::{config::ConsensusConfig, network_id::NetworkId};
use arx_consensus_types::proposal_msg::ProposalMsg;
...
use arx_safety_rules::{test_utils, SafetyRules, TSafetyRules};
use arx_types::{
...
fn create_node_for_fuzzing() -> RoundManager {
    ...
    let (self_sender, _self_receiver) = arx_channels::new_test(8);
