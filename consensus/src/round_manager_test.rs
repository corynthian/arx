...
impl NodeSetup {
    fn create_round_state(time_service: Arc<dyn TimeService>) -> RoundState {
        ...
        let (round_timeout_sender, _) = arx_channels::new_test(1_024);
    ...
    fn new(
        ...
        let (self_sender, self_receiver) = arx_channels::new_test(1000);
        ...
        let (round_manager_tx, _) = arx_channel::new(QueueStyle::LIFO, 1, None);
