...
use arx_executor_types::{BlockExecutorTrait, Error as ExecutionError, StateComputeResult};
...
pub struct ExecutionProxy {
    ...
    async_state_sync_notifier: arx_channel::Sender<NotificationType>,
...
impl ExecutionProxy {
    pub fn new(
        ...
        let (tx, mut rx) =
            arx_channel::new::<NotificationType>(10, &counters::PENDING_STATE_SYNC_NOTIFICATION);
