...
use arx_types::{block_info::BlockInfo, ledger_info::LedgerInfoWithSignatures};
...
/// This structure is a wrapper of [`ExecutedBlock`](arx_consensus_types::executed_block::ExecutedBlock)
