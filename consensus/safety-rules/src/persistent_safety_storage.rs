...
use arx_consensus_types::{common::Author, safety_data::SafetyData};
use arx_crypto::{bls12381, PrivateKey};
use arx_protocol_constants::{CONSENSUS_KEY, OWNER_ACCOUNT, SAFETY_DATA, WAYPOINT};
use arx_logger::prelude::*;
use arx_secure_storage::{KVStorage, Storage};
...
impl PersistentSafetyStorage {
    ...
    fn initialize_keys_and_accounts(
        ...
        // storage.
        if let Err(arx_secure_storage::Error::KeyAlreadyExists(_)) = result {
...
mod tests {
    ...
    use arx_secure_storage::InMemoryStorage;
    use arx_types::{
