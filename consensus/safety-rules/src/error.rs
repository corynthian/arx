...
impl From<arx_secure_storage::Error> for Error {
    fn from(error: arx_secure_storage::Error) -> Self {
        match error {
            arx_secure_storage::Error::PermissionDenied => {
            ...
            arx_secure_storage::Error::KeyVersionNotFound(_, _)
            | arx_secure_storage::Error::KeyNotSet(_) => {
