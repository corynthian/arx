...
use anyhow::ensure;
use arx_crypto::{bls12381, CryptoMaterialError};
use arx_crypto_derive::{BCSCryptoHash, CryptoHasher};
use arx_types::{
...
/// on the equivalent of a ArxBFT v4 timeout message.
...
/// have voted in round r and we can now move to round r+1. ArxBFT v4 requires signature to sign on
