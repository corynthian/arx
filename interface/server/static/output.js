...
var $author$project$Main$CredentialMsg = function (a) {
	return {$: 'CredentialMsg', a: a};
};
...
var $author$project$Main$default = F3(
	function (url, key, credential) {
		return {
			account: $author$project$Account$default(credential.arxAccountObject),
			credential: credential,
			key: key,
			responses: _List_Nil,
			subsidialis: $author$project$Subsidialis$default,
			url: url
		};
	});
var $author$project$Js$FetchAccount = {$: 'FetchAccount'};
...
var $author$project$Js$Data$encodeArxAccountObject = function (accountObject) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'address',
				$elm$json$Json$Encode$string(accountObject.address)),
				_Utils_Tuple2(
				'publicKeyHex',
				$elm$json$Json$Encode$string(accountObject.publicKeyHex)),
				_Utils_Tuple2(
				'privateKeyHex',
				$elm$json$Json$Encode$string(accountObject.privateKeyHex))
			]));
};
var $elm$json$Json$Encode$int = _Json_wrap;
var $author$project$Js$encodeCommand = function (cmd) {
	switch (cmd.$) {
		case 'FetchAccount':
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'commandType',
						$elm$json$Json$Encode$string('fetchAccount'))
					]));
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'commandType',
						$elm$json$Json$Encode$string('generateAccount'))
					]));
		case 'Faucet':
			var address = cmd.a;
			var amount = cmd.b;
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'commandType',
						$elm$json$Json$Encode$string('faucetArxCoin')),
						_Utils_Tuple2(
						'address',
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'commandType',
						$elm$json$Json$Encode$string('subsidialisAddCoins')),
						_Utils_Tuple2(
						'account',
						$author$project$Js$Data$encodeArxAccountObject(arxAccount)),
						_Utils_Tuple2(
...
var $author$project$Js$sendCommand = _Platform_outgoingPort('sendCommand', $elm$core$Basics$identity);
var $author$project$Credential$init = _Utils_Tuple2(
	{arxAccountObject: $elm$core$Maybe$Nothing},
	$author$project$Js$sendCommand(
		$author$project$Js$encodeCommand($author$project$Js$FetchAccount)));
var $author$project$Main$AccountMsg = function (a) {
	return {$: 'AccountMsg', a: a};
};
var $author$project$Main$SubsidialisMsg = function (a) {
	return {$: 'SubsidialisMsg', a: a};
};
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Account$init = function (arxAccountObject) {
	return _Utils_Tuple2(
		$author$project$Account$default(arxAccountObject),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Subsidialis$AddCoinsMsg = function (a) {
	return {$: 'AddCoinsMsg', a: a};
};
...
var $author$project$Generated$Api$Data$MoveResource = F2(
	function (type_, data) {
		return {data: data, type_: type_};
	});
var $author$project$Generated$Api$Data$decodeChain = $elm$json$Json$Decode$map2($elm$core$Basics$apR);
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Generated$Api$Data$decode = F2(
	function (key, decoder) {
		return $author$project$Generated$Api$Data$decodeChain(
			A2($elm$json$Json$Decode$field, key, decoder));
	});
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Generated$Api$Data$moveResourceDecoder = function (objectDecoder) {
	return A3(
		...
		A3(
			...
			$elm$json$Json$Decode$succeed($author$project$Generated$Api$Data$MoveResource)));
};
var $author$project$Generated$Api$Request = function (a) {
	return {$: 'Request', a: a};
};
...
var $author$project$Generated$Api$headers = $elm$core$List$filterMap(
	function (_v0) {
		var key = _v0.a;
		var value = _v0.b;
		return A2(
...
var $author$project$Generated$Api$interpolatePath = F2(
...
var $author$project$Generated$Api$queries = $elm$core$List$filterMap(
	function (_v0) {
		var key = _v0.a;
		var value = _v0.b;
		return A2(
...
var $author$project$Generated$Api$request = F7(
	function (method, path, pathParams, queryParams, headerParams, body, decoder) {
		return $author$project$Generated$Api$Request(
			{
				basePath: '/v1',
				body: A2(
				...
				decoder: decoder,
				headers: $author$project$Generated$Api$headers(headerParams),
				method: method,
				pathParams: A2($author$project$Generated$Api$interpolatePath, path, pathParams),
				queryParams: $author$project$Generated$Api$queries(queryParams),
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing
			});
	});
var $author$project$Generated$Api$Request$Accounts$getAccountResource = F4(
	function (address_path, resourceType_path, ledgerVersion_query, decoder) {
		return A7(
			$author$project$Generated$Api$request,
			'GET',
			...
			_List_fromArray(
				[
					_Utils_Tuple2(
					'address',
					$elm$core$Basics$identity(address_path)),
					_Utils_Tuple2(
					'resource_type',
					$elm$core$Basics$identity(resourceType_path))
				]),
			_List_fromArray(
				[
					_Utils_Tuple2(
					'ledger_version',
					A2($elm$core$Maybe$map, $elm$core$Basics$identity, ledgerVersion_query))
				]),
			_List_Nil,
			$elm$core$Maybe$Nothing,
			$author$project$Generated$Api$Data$moveResourceDecoder(decoder));
	});
var $author$project$Api$localNetworkUrl = 'http://localhost:8080/v1';
...
var $author$project$Generated$Api$decodeBody = F2(
...
var $author$project$Generated$Api$decodeResponse = F2(
			...
			default:
				...
				if ($elm$core$String$isEmpty(body)) {
					...
					if (_v1.$ === 'Ok') {
						...
						return A2($author$project$Generated$Api$decodeBody, decoder, body);
					}
				} else {
					return A2($author$project$Generated$Api$decodeBody, decoder, body);
				}
...
var $author$project$Generated$Api$expectJson = F3(
	function (mapError, toMsg, decoder) {
		return A2(
			...
			A2(
				...
				$author$project$Generated$Api$decodeResponse(decoder)));
	});
...
var $author$project$Generated$Api$sendWithCustomExpect = F2(
	function (expect, _v0) {
		var req = _v0.a;
		return $elm$http$Http$request(
			{
...
var $author$project$Generated$Api$sendWithCustomError = F3(
	function (mapError, toMsg, req) {
		return A2(
			$author$project$Generated$Api$sendWithCustomExpect,
			A2($author$project$Generated$Api$expectJson, mapError, toMsg),
			req);
	});
var $author$project$Generated$Api$send = F2(
	function (toMsg, req) {
		return A3($author$project$Generated$Api$sendWithCustomError, $elm$core$Basics$identity, toMsg, req);
	});
var $author$project$Generated$Api$withBasePath = F2(
...
var $author$project$Api$send = F3(
	function (basePath, toMsg, request) {
		return A2(
			$author$project$Generated$Api$send,
			toMsg,
			A2($author$project$Generated$Api$withBasePath, basePath, request));
	});
var $author$project$Generated$Api$Data$Subsidialis = F5(
	function (active, pendingActive, pendingInactive, totalActivePower, totalJoiningPower) {
		return {active: active, pendingActive: pendingActive, pendingInactive: pendingInactive, totalActivePower: totalActivePower, totalJoiningPower: totalJoiningPower};
	});
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Generated$Api$Data$subsidialisDecoder = A3(
	$author$project$Generated$Api$Data$decode,
	'total_joining_power',
	$elm$json$Json$Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				A3(
					...
					'active',
					$elm$json$Json$Decode$list($elm$json$Json$Decode$string),
					$elm$json$Json$Decode$succeed($author$project$Generated$Api$Data$Subsidialis))))));
var $author$project$Api$getSubsidialis = function (matchResult) {
	return A3(
		$author$project$Api$send,
		$author$project$Api$localNetworkUrl,
		matchResult,
		A4($author$project$Generated$Api$Request$Accounts$getAccountResource, '0x1', '0x1::subsidialis::Subsidialis', $elm$core$Maybe$Nothing, $author$project$Generated$Api$Data$subsidialisDecoder));
};
var $author$project$Subsidialis$AddCoins$init = _Utils_Tuple2($author$project$Subsidialis$AddCoins$default, $elm$core$Platform$Cmd$none);
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Subsidialis$Error = function (a) {
	return {$: 'Error', a: a};
};
var $author$project$Subsidialis$Subsidialis = function (a) {
	return {$: 'Subsidialis', a: a};
};
var $elm$core$Debug$toString = _Debug_toString;
var $author$project$Subsidialis$matchResult = function (r) {
	if (r.$ === 'Ok') {
		var result = r.a;
		return $author$project$Subsidialis$Subsidialis(result);
	} else {
		var err = r.a;
		return $author$project$Subsidialis$Error(
			$elm$core$Debug$toString(err));
	}
};
var $author$project$Subsidialis$init = function () {
	var _v0 = $author$project$Subsidialis$AddCoins$init;
	var addCoins = _v0.a;
	var addCoinsMsg = _v0.b;
	return _Utils_Tuple2(
		_Utils_update(
			$author$project$Subsidialis$default,
			{addCoins: addCoins}),
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Api$getSubsidialis($author$project$Subsidialis$matchResult),
					A2($elm$core$Platform$Cmd$map, $author$project$Subsidialis$AddCoinsMsg, addCoinsMsg)
				])));
}();
var $author$project$Main$initWithUrl = F2(
	function (model, url) {
		var _v0 = url.path;
		switch (_v0) {
			case '/subsidialis':
				var _v1 = $author$project$Subsidialis$init;
				var subModel = _v1.a;
				var subCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{subsidialis: subModel, url: url}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$SubsidialisMsg, subCmd));
			case '/subsidialis/add_coins':
				var _v2 = $author$project$Subsidialis$AddCoins$init;
				var subModel = _v2.a;
				var subCmd = _v2.b;
				...
				return _Utils_Tuple2(
					...
					A2($elm$core$Platform$Cmd$map, $author$project$Main$SubsidialisMsg, subCmd));
			default:
				var _v3 = $author$project$Account$init(model.credential.arxAccountObject);
				var subModel = _v3.a;
				var subCmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{account: subModel, url: url}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$AccountMsg, subCmd));
		}
	});
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var _v0 = $author$project$Credential$init;
		var credential = _v0.a;
		var credentialMsg = _v0.b;
		var _v1 = A2(
			$author$project$Main$initWithUrl,
			A3($author$project$Main$default, url, key, credential),
			url);
		var model = _v1.a;
		var cmdMsg = _v1.b;
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2($elm$core$Platform$Cmd$map, $author$project$Main$CredentialMsg, credentialMsg),
						cmdMsg
					])));
	});
var $author$project$Main$ReceiveJsResult = function (a) {
	return {$: 'ReceiveJsResult', a: a};
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Js$receiveResult = _Platform_incomingPort('receiveResult', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Js$receiveResult($author$project$Main$ReceiveJsResult);
};
var $author$project$Credential$ArxAccountObject = function (a) {
	return {$: 'ArxAccountObject', a: a};
};
var $author$project$Credential$Fetched = function (a) {
	return {$: 'Fetched', a: a};
};
var $author$project$Account$Hashes = function (a) {
	return {$: 'Hashes', a: a};
};
var $author$project$Js$Error = function (a) {
	return {$: 'Error', a: a};
};
var $author$project$Js$Account = function (a) {
	return {$: 'Account', a: a};
};
var $author$project$Js$Data$ArxAccountObject = F3(
	function (address, publicKeyHex, privateKeyHex) {
		return {address: address, privateKeyHex: privateKeyHex, publicKeyHex: publicKeyHex};
	});
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$Js$Data$arxAccountObjectDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Js$Data$ArxAccountObject,
	A2($elm$json$Json$Decode$field, 'address', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'publicKeyHex', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'privateKeyHex', $elm$json$Json$Decode$string));
var $author$project$Js$accountDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Js$Account,
	A2($elm$json$Json$Decode$field, 'account', $author$project$Js$Data$arxAccountObjectDecoder));
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $author$project$Js$Fetched = function (a) {
	return {$: 'Fetched', a: a};
};
...
var $author$project$Js$fetchedDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Js$Fetched,
	A2(
		$elm$json$Json$Decode$field,
		'account',
		$elm$json$Json$Decode$maybe($author$project$Js$Data$arxAccountObjectDecoder)));
var $author$project$Js$TxnHash = function (a) {
	return {$: 'TxnHash', a: a};
};
var $author$project$Js$hashDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Js$TxnHash,
	A2($elm$json$Json$Decode$field, 'hash', $elm$json$Json$Decode$string));
var $author$project$Js$Hashes = function (a) {
	return {$: 'Hashes', a: a};
};
var $author$project$Js$hashesDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Js$Hashes,
	A2(
		$elm$json$Json$Decode$field,
		'hashes',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$Js$decodeResult = function (res) {
	var _v0 = A2(
		$elm$json$Json$Decode$decodeValue,
		A2($elm$json$Json$Decode$field, 'resultType', $elm$json$Json$Decode$string),
		res);
	if (_v0.$ === 'Ok') {
		var resultType = _v0.a;
		switch (resultType) {
			case 'fetched':
				var _v2 = A2($elm$json$Json$Decode$decodeValue, $author$project$Js$fetchedDecoder, res);
				if (_v2.$ === 'Ok') {
					var fetched = _v2.a;
					return fetched;
				} else {
					var err = _v2.a;
					return $author$project$Js$Error(
						$elm$json$Json$Decode$errorToString(err));
				}
			case 'account':
				var _v3 = A2($elm$json$Json$Decode$decodeValue, $author$project$Js$accountDecoder, res);
				if (_v3.$ === 'Ok') {
					var account = _v3.a;
					return account;
				} else {
			...
			case 'hashes':
				var _v4 = A2($elm$json$Json$Decode$decodeValue, $author$project$Js$hashesDecoder, res);
				if (_v4.$ === 'Ok') {
					var hashes = _v4.a;
					return hashes;
				} else {
			...
			case 'hash':
				var _v5 = A2($elm$json$Json$Decode$decodeValue, $author$project$Js$hashDecoder, res);
				if (_v5.$ === 'Ok') {
					var hash = _v5.a;
					return hash;
				} else {
			...
			default:
				return $author$project$Js$Error('Unsupported result type');
		}
	} else {
		var err = _v0.a;
		return $author$project$Js$Error(
...
var $author$project$Account$ArxCoin = function (a) {
	return {$: 'ArxCoin', a: a};
};
var $author$project$Generated$Api$Data$CoinStore = F4(
	function (coin, depositEvents, frozen, withdrawEvents) {
		return {coin: coin, depositEvents: depositEvents, frozen: frozen, withdrawEvents: withdrawEvents};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Generated$Api$Data$CoinValue = function (value) {
	return {value: value};
};
var $author$project$Generated$Api$Data$coinValueDecoder = A3(
	$author$project$Generated$Api$Data$decode,
	'value',
	$elm$json$Json$Decode$string,
	$elm$json$Json$Decode$succeed($author$project$Generated$Api$Data$CoinValue));
var $author$project$Generated$Api$Data$EventObject = F2(
	function (counter, guid) {
		return {counter: counter, guid: guid};
	});
var $author$project$Generated$Api$Data$Guid = function (id) {
	return {id: id};
};
var $author$project$Generated$Api$Data$GuidAddress = F2(
	function (addr, creationNum) {
		return {addr: addr, creationNum: creationNum};
	});
var $author$project$Generated$Api$Data$guidAddressDecoder = A3(
	$author$project$Generated$Api$Data$decode,
	'creation_num',
	$elm$json$Json$Decode$string,
	A3(
		...
		'addr',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Generated$Api$Data$GuidAddress)));
var $author$project$Generated$Api$Data$guidDecoder = A3(
	$author$project$Generated$Api$Data$decode,
	'id',
	$author$project$Generated$Api$Data$guidAddressDecoder,
	$elm$json$Json$Decode$succeed($author$project$Generated$Api$Data$Guid));
var $author$project$Generated$Api$Data$eventObjectDecoder = A3(
	$author$project$Generated$Api$Data$decode,
	'guid',
	$author$project$Generated$Api$Data$guidDecoder,
	A3(
		$author$project$Generated$Api$Data$decode,
		'counter',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Generated$Api$Data$EventObject)));
var $author$project$Generated$Api$Data$coinStoreDecoder = A3(
	$author$project$Generated$Api$Data$decode,
	'withdraw_events',
	$author$project$Generated$Api$Data$eventObjectDecoder,
	A3(
		$author$project$Generated$Api$Data$decode,
		'frozen',
		...
		A3(
			...
			A3(
				$author$project$Generated$Api$Data$decode,
				'coin',
				$author$project$Generated$Api$Data$coinValueDecoder,
				$elm$json$Json$Decode$succeed($author$project$Generated$Api$Data$CoinStore)))));
var $author$project$Api$getAccountArxCoinResource = F2(
	function (matchResult, address) {
		return A3(
			$author$project$Api$send,
			$author$project$Api$localNetworkUrl,
			matchResult,
			A4($author$project$Generated$Api$Request$Accounts$getAccountResource, address, '0x1::coin::CoinStore<0x1::arx_coin::ArxCoin>', $elm$core$Maybe$Nothing, $author$project$Generated$Api$Data$coinStoreDecoder));
	});
var $author$project$Account$Error = function (a) {
	return {$: 'Error', a: a};
};
var $author$project$Account$matchResult = F2(
	function (f, r) {
		if (r.$ === 'Ok') {
			var result = r.a;
			return f(result);
			...
			var err = r.a;
			return $author$project$Account$Error(
				$elm$core$Debug$toString(err));
		}
	});
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Account$parseBalanceString = function (s) {
	var _v0 = A2($elm$json$Json$Decode$decodeString, $elm$json$Json$Decode$int, s);
	if (_v0.$ === 'Ok') {
		var amount = _v0.a;
		return amount;
	} else {
...
var $author$project$Subsidialis$AddCoins$parseAmountString = function (s) {
	var _v0 = A2($elm$json$Json$Decode$decodeString, $elm$json$Json$Decode$int, s);
	if (_v0.$ === 'Ok') {
		var amount = _v0.a;
		return amount;
...
var $author$project$Subsidialis$AddCoins$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SendJsCommand':
				var cmd = msg.a;
			...
			case 'AddCoins':
				...
				if (_v1.$ === 'Just') {
					...
					var cmd = A2(
						$author$project$Js$SubsidialisAddCoins,
						arxAccountObject,
						$author$project$Subsidialis$AddCoins$parseAmountString(model.amount));
					return _Utils_Tuple2(
						model,
						$author$project$Js$sendCommand(
							$author$project$Js$encodeCommand(cmd)));
...
var $author$project$Subsidialis$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'GetSubsidialis':
				return _Utils_Tuple2(
			...
			case 'AddCoinsMsg':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{addCoins: subModel}),
					A2($elm$core$Platform$Cmd$map, $author$project$Subsidialis$AddCoinsMsg, cmdMsg));
			default:
				var err = msg.a;
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Js$GenerateAccount = {$: 'GenerateAccount'};
var $author$project$Credential$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SendJsCommand':
				var cmd = msg.a;
				return _Utils_Tuple2(
					...
					$author$project$Js$sendCommand(
						$author$project$Js$encodeCommand(cmd)));
			case 'Fetched':
				var maybeArxAccountObject = msg.a;
				if (maybeArxAccountObject.$ === 'Just') {
					var arxAccountObject = maybeArxAccountObject.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
					...
					return _Utils_Tuple2(
						model,
						$author$project$Js$sendCommand(
							$author$project$Js$encodeCommand($author$project$Js$GenerateAccount)));
				}
			case 'ArxAccountObject':
				var arxAccountObject = msg.a;
				var _v2 = A2($elm$core$Debug$log, 'credential', arxAccountObject);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
			...
			default:
				var err = msg.a;
				var _v3 = A2($elm$core$Debug$log, 'credential-error', err);
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$updateCredentials = F2(
	function (subMsg, model) {
		var _v0 = A2($author$project$Credential$update, subMsg, model.credential);
		var credential = _v0.a;
		var cmdMsg = _v0.b;
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				var url = msg.a;
				return A2($author$project$Main$initWithUrl, model, url);
			case 'CredentialMsg':
				var subMsg = msg.a;
				var _v2 = A2($elm$core$Debug$log, 'main', 'updating credentials');
				return A2($author$project$Main$updateCredentials, subMsg, model);
			case 'AccountMsg':
				var subMsg = msg.a;
				var _v3 = A2($author$project$Account$update, subMsg, model.account);
				var subModel = _v3.a;
				var cmdMsg = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{account: subModel}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$AccountMsg, cmdMsg));
			case 'SubsidialisMsg':
				var subMsg = msg.a;
				var _v4 = A2($author$project$Subsidialis$update, subMsg, model.subsidialis);
				var subModel = _v4.a;
				var cmdMsg = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{subsidialis: subModel}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$SubsidialisMsg, cmdMsg));
			default:
				var res = msg.a;
				var _v5 = $author$project$Js$decodeResult(res);
				switch (_v5.$) {
					case 'Fetched':
						var maybeAccount = _v5.a;
						return A2(
							$author$project$Main$updateCredentials,
							$author$project$Credential$Fetched(maybeAccount),
							model);
					case 'Account':
						var account = _v5.a;
						return A2(
							$author$project$Main$updateCredentials,
							$author$project$Credential$ArxAccountObject(account),
							model);
					case 'Hashes':
						var hashes = _v5.a;
						var _v6 = A2(
							$author$project$Account$update,
							$author$project$Account$Hashes(hashes),
							model.account);
						var subModel = _v6.a;
						var cmdMsg = _v6.b;
						return _Utils_Tuple2(
...
var $author$project$Styles$Fonts$barlowCondensed = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Styles$Theme$geyser = $rtfeldman$elm_css$Css$hex('D1DBE5');
var $author$project$Styles$Theme$havelockBlue = $rtfeldman$elm_css$Css$hex('5791D8');
...
var $author$project$Styles$Theme$mirage = $rtfeldman$elm_css$Css$hex('1B222E');
...
var $author$project$Styles$Breakpoints$custom = function (width) {
	return $rtfeldman$elm_css$Css$Media$withMedia(
		_List_fromArray(
			[
...
var $author$project$Styles$Breakpoints$small = $author$project$Styles$Breakpoints$custom(768);
...
var $author$project$Layout$Navigation$css = _List_fromArray(
	[
		...
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Styles$Breakpoints$small(
										_List_fromArray(
											[
												$rtfeldman$elm_css$Css$padding(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$color($author$project$Styles$Theme$mirage),
						$rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none),
						$author$project$Styles$Fonts$barlowCondensed,
						$rtfeldman$elm_css$Css$fontSize(
						$rtfeldman$elm_css$Css$rem(1.5)),
						$rtfeldman$elm_css$Css$hover(
						_List_fromArray(
							[
								A3($rtfeldman$elm_css$Css$textDecoration3, $rtfeldman$elm_css$Css$underline, $rtfeldman$elm_css$Css$solid, $author$project$Styles$Theme$havelockBlue)
							]))
					])),
				A2(
				$rtfeldman$elm_css$Css$Global$selector,
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$color($author$project$Styles$Theme$mirage),
						$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$Theme$geyser),
						$rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none),
						$author$project$Styles$Fonts$barlowCondensed,
						$rtfeldman$elm_css$Css$fontSize(
...
var $author$project$Js$Faucet = F2(
	function (a, b) {
		return {$: 'Faucet', a: a, b: b};
	});
var $author$project$Account$SendJsCommand = function (a) {
	return {$: 'SendJsCommand', a: a};
};
...
var $author$project$Styles$Elements$btn = A2(
	...
	_List_fromArray(
		[
			...
			$author$project$Styles$Fonts$barlowCondensed,
			$rtfeldman$elm_css$Css$color($author$project$Styles$Theme$geyser),
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$Theme$mirage)
		]));
...
var $author$project$Account$containerBodyStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
...
var $author$project$Account$containerHeaderStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Account$listLeftStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
...
var $author$project$Account$listRightStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$row),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Styles$Theme$white = $rtfeldman$elm_css$Css$hex('FFFFFF');
var $author$project$Account$listStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$row),
		$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$Theme$white),
		$rtfeldman$elm_css$Css$flexGrow(
		$rtfeldman$elm_css$Css$int(1)),
		$rtfeldman$elm_css$Css$borderRadius(
		$rtfeldman$elm_css$Css$px(10)),
...
var $author$project$Layout$Centered$leftStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Layout$Centered$middleStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Layout$Centered$rightStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Layout$Centered$view = function (content) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Layout$Centered$containerStyle)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Layout$Centered$leftStyle)
							]),
						_List_Nil),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Layout$Centered$middleStyle)
							]),
						content),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Layout$Centered$rightStyle)
							]),
						_List_Nil)
					]))
			]));
...
var $author$project$Account$view = function (model) {
	return $author$project$Layout$Centered$view(
		_List_fromArray(
			[
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Account$containerHeaderStyle)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Account$containerBodyStyle)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Account$listStyle)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Account$listLeftStyle)
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('COINS')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$div,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Account$listRightStyle)
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('SEIGNORAGE')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$div,
								_List_fromArray(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('FAUCET ARX')
							]))
					]))
			]));
};
...
var $author$project$Subsidialis$containerBodyCss = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Subsidialis$containerHeaderCss = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Subsidialis$containersCss = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$row),
		$rtfeldman$elm_css$Css$margin(
...
var $author$project$Subsidialis$css = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
		$rtfeldman$elm_css$Css$justifyContent($rtfeldman$elm_css$Css$center),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$color($author$project$Styles$Theme$havelockBlue),
						$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$Theme$mirage),
						$rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none),
						$author$project$Styles$Fonts$barlowCondensed,
						$rtfeldman$elm_css$Css$fontSize(
						...
						_List_fromArray(
							[
								A3($rtfeldman$elm_css$Css$textDecoration3, $rtfeldman$elm_css$Css$underline, $rtfeldman$elm_css$Css$solid, $author$project$Styles$Theme$mirage)
							]))
					]))
			]))
	]);
...
var $author$project$Subsidialis$leavingContainerCss = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Styles$Elements$listElement = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
...
var $author$project$Subsidialis$pendingContainerCss = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Subsidialis$view = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$containersCss)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$activeContainerCss)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$containerHeaderCss)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$containerBodyCss)
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(
										$elm$core$Debug$toString(model.active))
									]))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$pendingContainerCss)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('PENDING')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$div,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(
										$elm$core$Debug$toString(model.pendingActive))
									]))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$leavingContainerCss)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('LEAVING')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$div,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text(
										$elm$core$Debug$toString(model.pendingInactive))
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$css)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$class('listElement')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$href('/subsidialis/add_coins')
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('ADD ARX COINS')
									]))
							])),
						A2(
						$author$project$Styles$Elements$listElement,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$href('/subsidialis/add_liquidity')
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('ADD ARX:XUSD LIQUIDITY')
									]))
							])),
						A2(
						$author$project$Styles$Elements$listElement,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$href('/subsidialis/remove_coins')
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('REMOVE ARX COINS')
									]))
							])),
						A2(
						$author$project$Styles$Elements$listElement,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$href('/subsidialis/remove_liquidity')
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('REMOVE ARX:XUSD LIQUIDITY')
									]))
							])),
						A2(
						$author$project$Styles$Elements$listElement,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$href('/subsidialis/leave')
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('LEAVE SUBSIDIALIS')
									]))
							]))
					]))
			]));
};
var $author$project$Subsidialis$AddCoins$AddCoins = {$: 'AddCoins'};
var $author$project$Subsidialis$AddCoins$UpdateAmount = function (a) {
	return {$: 'UpdateAmount', a: a};
};
var $author$project$Subsidialis$AddCoins$containerBodyStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Subsidialis$AddCoins$containerHeaderStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Styles$Elements$formLeftStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$row),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Styles$Elements$formRightStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$row),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Styles$Elements$formStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$row),
		$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$Theme$white),
...
var $author$project$Layout$Centered$formContainerStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$row),
		$rtfeldman$elm_css$Css$margin(
...
var $author$project$Layout$Centered$formLeftStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Layout$Centered$formMiddleStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Layout$Centered$formRightStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$flexGrow(
...
var $author$project$Layout$Centered$formView = function (content) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Layout$Centered$formContainerStyle)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Layout$Centered$formLeftStyle)
							]),
						_List_Nil),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Layout$Centered$formMiddleStyle)
							]),
						content),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Layout$Centered$formRightStyle)
							]),
						_List_Nil)
					]))
			]));
...
var $author$project$Subsidialis$AddCoins$inputStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$padding(
		...
		$author$project$Styles$Theme$geyser)
	]);
...
var $author$project$Subsidialis$AddCoins$view = function (model) {
	return $author$project$Layout$Centered$formView(
		_List_fromArray(
			[
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$AddCoins$containerHeaderStyle)
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('ADD COINS')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$AddCoins$containerBodyStyle)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Styles$Elements$formStyle)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Styles$Elements$formLeftStyle)
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('AMOUNT')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$div,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Styles$Elements$formRightStyle)
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Subsidialis$AddCoins$inputStyle),
												$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Subsidialis$AddCoins$UpdateAmount)
											]),
										_List_Nil),
										A2(
										$author$project$Styles$Elements$btn,
										...
										_List_fromArray(
											[
												$rtfeldman$elm_css$Html$Styled$text('MAX')
											]))
									]))
							])),
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Subsidialis$AddCoins$AddCoins)
							]),
						_List_fromArray(
							[
	...
	switch (_v0) {
		...
		case '/subsidialis/add_coins':
			return A2(
				...
				A2(
					$rtfeldman$elm_css$Html$Styled$map,
					$author$project$Subsidialis$AddCoinsMsg,
					$author$project$Subsidialis$AddCoins$view(model.subsidialis.addCoins)));
		default:
			return A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Responses'),
						A2(
						$rtfeldman$elm_css$Html$Styled$ul,
						_List_Nil,
						A2(
...
var $author$project$Styles$Branding$logo = A2(
	$rtfeldman$elm_css$Html$Styled$img,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$src('/static/arx_brand.png'),
...
var $author$project$Styles$Theme$ochre = $rtfeldman$elm_css$Css$hex('DB7623');
var $author$project$Credential$style = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
		$rtfeldman$elm_css$Css$justifyContent($rtfeldman$elm_css$Css$center),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$rtfeldman$elm_css$Css$marginLeft($rtfeldman$elm_css$Css$auto),
												$rtfeldman$elm_css$Css$color($author$project$Styles$Theme$ochre)
											])),
										$author$project$Styles$Fonts$barlowCondensed,
										$rtfeldman$elm_css$Css$fontSize(
...
var $author$project$Credential$navigation = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Credential$style)
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$class('credentialNavigation')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$class('credentialNavigation__item')
						]),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('1 ARX = 1.000 XUSD')
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$li,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('DISCONNECTED')
						]))
				]))
		]));
var $rtfeldman$elm_css$Css$overflow = $rtfeldman$elm_css$Css$prop1('overflow');
var $author$project$Main$style = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$displayFlex,
		$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
		$rtfeldman$elm_css$Css$width(
		...
		$rtfeldman$elm_css$Css$height(
		$rtfeldman$elm_css$Css$pct(100)),
		$rtfeldman$elm_css$Css$backgroundColor($author$project$Styles$Theme$havelockBlue),
		$rtfeldman$elm_css$Css$Global$descendants(
		_List_fromArray(
			[
				A2(
...
var $author$project$Credential$SendJsCommand = function (a) {
	return {$: 'SendJsCommand', a: a};
};
var $elm$core$String$toUpper = _String_toUpper;
var $author$project$Credential$renderAddress = function (address) {
	var start = A3($elm$core$String$slice, 0, 2, address);
	var end = A3(
		$elm$core$String$slice,
		2,
		20,
		$elm$core$String$toUpper(address));
	return start + (end + '...');
};
var $author$project$Credential$view = function (model) {
	var _v0 = model.arxAccountObject;
	if (_v0.$ === 'Just') {
		var arxAccountObject = _v0.a;
		var address = arxAccountObject.address;
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$href('/account')
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(
									$author$project$Credential$renderAddress(address))
								]))
						]))
				]));
	} else {
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Events$onClick(
					$author$project$Credential$SendJsCommand($author$project$Js$GenerateAccount))
				]),
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('GENERATE ACCOUNT')
				]));
	}
};
var $author$project$Layout$Navigation$viewLink = F2(
	function (path, content) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$li,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$class('navigation__item')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Layout$Navigation$view = function (accountView) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$ul,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$class('navigation')
			]),
		_List_fromArray(
			[
				A2($author$project$Layout$Navigation$viewLink, '/account', 'ACCOUNT'),
				A2($author$project$Layout$Navigation$viewLink, '/subsidialis', 'SUBSIDIALIS'),
				A2($author$project$Layout$Navigation$viewLink, '/senatus', 'SENATUS'),
				A2($author$project$Layout$Navigation$viewLink, '/magisterium', 'MAGISTERIUM'),
				A2($author$project$Layout$Navigation$viewLink, '/liquidity', 'LIQUIDITY'),
				A2($author$project$Layout$Navigation$viewLink, '/liquidity', 'SWAP'),
				A2(
				$rtfeldman$elm_css$Html$Styled$li,
				_List_fromArray(
					[
		...
		body: _List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Main$style)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$author$project$Styles$Branding$logo,
									A2(
									$rtfeldman$elm_css$Html$Styled$div,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											...
											_Utils_ap(
												...
												$author$project$Layout$Navigation$css))
										]),
									_List_fromArray(
										[
											$author$project$Layout$Navigation$view(
											A2(
												$rtfeldman$elm_css$Html$Styled$map,
												$author$project$Main$CredentialMsg,
												$author$project$Credential$view(model.credential)))
										]))
								])),
							A2(
							...
							_List_fromArray(
								[
									$author$project$Credential$navigation,
									$author$project$Main$loadView(model)
								]))
						])))
			]),
		title: 'ARX'
