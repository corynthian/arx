...
use arx_scratchpad::{ProofRead, SparseMerkleTree};
use arx_types::{
...
pub struct StateComputeResult {
    ...
    /// after the execution. For details, please see [`InMemoryAccumulator`](arx_types::proof::accumulator::InMemoryAccumulator).
