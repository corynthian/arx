...
use arx_db::ArxDB;
use arx_executor_types::{BlockExecutorTrait, ChunkExecutorTrait, TransactionReplayer};
...
impl TestExecutor {
    fn new() -> TestExecutor {
        ...
        let db = DbReaderWriter::new(ArxDB::new_for_test(path.path()));
