...
use arx_storage_interface::cached_state_view::CachedStateView;
use arx_types::{
...
// We use 10 as the assertion error code for insufficient balance within the Arx coin contract.
