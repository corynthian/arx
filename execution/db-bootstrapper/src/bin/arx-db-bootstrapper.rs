...
use arx_db::ArxDB;
use arx_executor::db_bootstrapper::calculate_genesis;
use arx_storage_interface::DbReaderWriter;
use arx_types::{transaction::Transaction, waypoint::Waypoint};
use arx_vm::ArxVM;
use std::{
    fs::File,
    io::Read,
...
fn main() -> Result<()> {
    ...
    let committer = calculate_genesis::<ArxVM>(&db, executed_trees, &genesis_txn)
