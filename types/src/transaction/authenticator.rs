...
use arx_crypto_derive::{CryptoHasher, DeserializeKey, SerializeKey};
...
/// Each transaction submitted to the Arx blockchain contains a `TransactionAuthenticator`. During
