...
use arx_crypto::{bls12381, bls12381::PublicKey, hash::CryptoHash, Signature, VerifyingKey};
#[cfg(any(test, feature = "fuzzing"))]
...
mod tests {
    use super::*;
    use crate::validator_signer::ValidatorSigner;
    use arx_crypto::test_utils::{TestArxCrypto, TEST_SEED};
    ...
    fn test_check_voting_power() {
        ...
        let dummy_struct = TestArxCrypto("Hello, World".to_string());
