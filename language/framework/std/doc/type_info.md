...
Returns the current chain ID, mirroring what <code>arx_framework::chain_id::get()</code> would return, except in <code>#[test]</code>
functions, where this will always return <code>4u8</code> as the chain ID, whereas <code>arx_framework::chain_id::get()</code> will
return whichever ID was passed to <code>arx_framework::chain_id::initialize_for_test()</code>.
