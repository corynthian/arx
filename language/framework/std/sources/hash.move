...
module std::hash {
    ...
    /// Returns the SHA2-256 hash of `bytes`.
    native public fun sha2_256(bytes: vector<u8>): vector<u8>;

    /// Returns the SHA3-256 hash of `bytes`.
    native public fun sha3_256(bytes: vector<u8>): vector<u8>;
