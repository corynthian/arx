...
module std::bls12381 {
    ...
    /// The message signed is "Hello Arx!" and the associated SK is 07416693b6b32c84abe45578728e2379f525729e5b94762435a31e65ecc728da.
    ...
    fun test_verify_aggsig() {
        ...
        // The signed messages are "Hello, Arx <i>!", where <i> \in {1, ..., 5}
        let msgs = vector[
