...
module arx::code {
    ...
    const EUPGRADE_WEAKER_PArxICY: u64 = 0x3;
    ...
    const EDEP_WEAKER_PArxICY: u64 = 0x6;
    ...
    const EINCOMPATIBLE_PArxICY_DISABLED: u64 = 0x8;
    ...
    fun initialize(arx: &signer, package_owner: &signer, metadata: PackageMetadata)
    ...
    public fun publish_package(owner: &signer, pack: PackageMetadata, code: vector<vector<u8>>) acquires PackageRegistry {
        ...
        assert!(
            ...
            error::invalid_argument(EINCOMPATIBLE_PArxICY_DISABLED),
        );
    ...
    fun check_upgradability(
        ...
        assert!(can_change_upgrade_policy_to(old_pack.upgrade_policy, new_pack.upgrade_policy),
            error::invalid_argument(EUPGRADE_WEAKER_PArxICY));
            ...
            while (j < m) {
                ...
                if (dep_pack.name == dep.package_name) {
                    ...
                    assert!(
                        ...
                        error::invalid_argument(EDEP_WEAKER_PArxICY)
                    );
