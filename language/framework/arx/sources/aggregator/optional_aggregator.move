...
module arx::optional_aggregator {
    use std::error;
    ...
    #[test(account = @arx)]
    #[expected_failure(abort_code = 0x020001, location = arx::aggregator)]
    ...
    #[test(account = @arx)]
    #[expected_failure(abort_code = 0x020002, location = arx::aggregator)]
