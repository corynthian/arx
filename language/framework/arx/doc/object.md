...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_object_id">create_object_id</a>(source: &<b>address</b>, seed: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="object.md#0x1_object_ObjectId">object::ObjectId</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_object_id">create_object_id</a>(source: &<b>address</b>, seed: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="object.md#0x1_object_ObjectId">ObjectId</a> {
    ...
    <a href="../../std/doc/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> bytes, <a href="object.md#0x1_object_OBJECT_ADDRESS_SCHEME">OBJECT_ADDRESS_SCHEME</a>);
    <a href="object.md#0x1_object_ObjectId">ObjectId</a> { inner: <a href="../../std/doc/from_bcs.md#0x1_from_bcs_to_address">from_bcs::to_address</a>(<a href="../../std/doc/hash.md#0x1_hash_sha3_256">hash::sha3_256</a>(bytes)) }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_named_object">create_named_object</a>(creator: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, seed: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="object.md#0x1_object_CreatorRef">object::CreatorRef</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_named_object">create_named_object</a>(creator: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, seed: <a href="../../std/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="object.md#0x1_object_CreatorRef">CreatorRef</a> {
    <b>let</b> creator_address = <a href="../../std/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(creator);
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_object_from_account">create_object_from_account</a>(creator: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>): <a href="object.md#0x1_object_CreatorRef">object::CreatorRef</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_object_from_account">create_object_from_account</a>(creator: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>): <a href="object.md#0x1_object_CreatorRef">CreatorRef</a> {
    <b>let</b> <a href="guid.md#0x1_guid">guid</a> = <a href="account.md#0x1_account_create_guid">account::create_guid</a>(creator);
    <a href="object.md#0x1_object_create_object_from_guid">create_object_from_guid</a>(<a href="../../std/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(creator), <a href="guid.md#0x1_guid">guid</a>)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_object_from_object">create_object_from_object</a>(creator: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>): <a href="object.md#0x1_object_CreatorRef">object::CreatorRef</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_object_from_object">create_object_from_object</a>(creator: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>): <a href="object.md#0x1_object_CreatorRef">CreatorRef</a> <b>acquires</b> <a href="object.md#0x1_object_Object">Object</a> {
...
<pre><code><b>fun</b> <a href="object.md#0x1_object_create_object_from_guid">create_object_from_guid</a>(creator_address: <b>address</b>, <a href="guid.md#0x1_guid">guid</a>: <a href="guid.md#0x1_guid_GUID">guid::GUID</a>): <a href="object.md#0x1_object_CreatorRef">CreatorRef</a> {
    <b>let</b> bytes = <a href="../../std/doc/bcs.md#0x1_bcs_to_bytes">bcs::to_bytes</a>(&<a href="guid.md#0x1_guid">guid</a>);
    <a href="../../std/doc/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> bytes, <a href="object.md#0x1_object_OBJECT_ADDRESS_SCHEME">OBJECT_ADDRESS_SCHEME</a>);
    <b>let</b> object_id = <a href="object.md#0x1_object_ObjectId">ObjectId</a> { inner: <a href="../../std/doc/from_bcs.md#0x1_from_bcs_to_address">from_bcs::to_address</a>(<a href="../../std/doc/hash.md#0x1_hash_sha3_256">hash::sha3_256</a>(bytes)) };
...
<pre><code><b>fun</b> <a href="object.md#0x1_object_create_object_internal">create_object_internal</a>(
    ...
    <b>assert</b>!(!<b>exists</b>&lt;<a href="object.md#0x1_object_Object">Object</a>&gt;(id.inner), <a href="../../std/doc/error.md#0x1_error_already_exists">error::already_exists</a>(<a href="object.md#0x1_object_EOBJECT_EXISTS">EOBJECT_EXISTS</a>));
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_generate_delete_ref">generate_delete_ref</a>(ref: &<a href="object.md#0x1_object_CreatorRef">CreatorRef</a>): <a href="object.md#0x1_object_DeleteRef">DeleteRef</a> {
    <b>assert</b>!(ref.can_delete, <a href="../../std/doc/error.md#0x1_error_permission_denied">error::permission_denied</a>(<a href="object.md#0x1_object_ECANNOT_DELETE">ECANNOT_DELETE</a>));
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_generate_signer">generate_signer</a>(ref: &<a href="object.md#0x1_object_CreatorRef">object::CreatorRef</a>): <a href="../../std/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_generate_signer">generate_signer</a>(ref: &<a href="object.md#0x1_object_CreatorRef">CreatorRef</a>): <a href="../../std/doc/signer.md#0x1_signer">signer</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_guid">create_guid</a>(<a href="object.md#0x1_object">object</a>: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>): <a href="guid.md#0x1_guid_GUID">guid::GUID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_guid">create_guid</a>(<a href="object.md#0x1_object">object</a>: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>): <a href="guid.md#0x1_guid_GUID">guid::GUID</a> <b>acquires</b> <a href="object.md#0x1_object_Object">Object</a> {
    <b>let</b> addr = <a href="../../std/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="object.md#0x1_object">object</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_new_event_handle">new_event_handle</a>&lt;T: drop, store&gt;(<a href="object.md#0x1_object">object</a>: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>): <a href="event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_new_event_handle">new_event_handle</a>&lt;T: drop + store&gt;(
    <a href="object.md#0x1_object">object</a>: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>,
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_generate_signer_for_extending">generate_signer_for_extending</a>(ref: &<a href="object.md#0x1_object_ExtendRef">object::ExtendRef</a>): <a href="../../std/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_generate_signer_for_extending">generate_signer_for_extending</a>(ref: &<a href="object.md#0x1_object_ExtendRef">ExtendRef</a>): <a href="../../std/doc/signer.md#0x1_signer">signer</a> {
    <a href="create_signer.md#0x1_create_signer">create_signer</a>(ref.self.inner)
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="object.md#0x1_object_transfer_call">transfer_call</a>(owner: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, object_id: <b>address</b>, <b>to</b>: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_transfer">transfer</a>(owner: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, object_id: <a href="object.md#0x1_object_ObjectId">object::ObjectId</a>, <b>to</b>: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_transfer_to_object">transfer_to_object</a>(owner: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>, object_id: <a href="object.md#0x1_object_ObjectId">object::ObjectId</a>, <b>to</b>: <a href="object.md#0x1_object_ObjectId">object::ObjectId</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="object.md#0x1_object_verify_ungated_and_descendant">verify_ungated_and_descendant</a>(owner: <b>address</b>, destination: <b>address</b>) <b>acquires</b> <a href="object.md#0x1_object_Object">Object</a> {
    ...
    <b>assert</b>!(
        ...
        <a href="../../std/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="object.md#0x1_object_EOBJECT_DOES_NOT_EXIST">EOBJECT_DOES_NOT_EXIST</a>),
    );
    ...
    <b>assert</b>!(
        ...
        <a href="../../std/doc/error.md#0x1_error_permission_denied">error::permission_denied</a>(<a href="object.md#0x1_object_ENO_UNGATED_TRANSFERS">ENO_UNGATED_TRANSFERS</a>),
    );
    ...
    <b>while</b> (owner != current_address) {
        ...
        <b>assert</b>!(count &lt; <a href="object.md#0x1_object_MAXIMUM_OBJECT_NESTING">MAXIMUM_OBJECT_NESTING</a>, <a href="../../std/doc/error.md#0x1_error_out_of_range">error::out_of_range</a>(<a href="object.md#0x1_object_EMAXIMUM_NESTING">EMAXIMUM_NESTING</a>));

        // At this point, the first <a href="object.md#0x1_object">object</a> <b>exists</b> and so the more likely case is that the
        // <a href="object.md#0x1_object">object</a>'s owner is not an <a href="object.md#0x1_object">object</a>. So we <b>return</b> a more sensible <a href="../../std/doc/error.md#0x1_error">error</a>.
        <b>assert</b>!(
            <b>exists</b>&lt;<a href="object.md#0x1_object_Object">Object</a>&gt;(current_address),
            <a href="../../std/doc/error.md#0x1_error_permission_denied">error::permission_denied</a>(<a href="object.md#0x1_object_ENOT_OBJECT_OWNER">ENOT_OBJECT_OWNER</a>),
        );
        <b>let</b> <a href="object.md#0x1_object">object</a> = <b>borrow_global</b>&lt;<a href="object.md#0x1_object_Object">Object</a>&gt;(current_address);
        <b>assert</b>!(
            <a href="object.md#0x1_object">object</a>.allow_ungated_transfer,
