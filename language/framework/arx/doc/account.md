...
-  [Function `create_reserved_account`](#0x1_account_create_reserved_account)
...
-  [Specification](#@Specification_1)
    ...
    -  [Function `create_reserved_account`](#@Specification_1_create_reserved_account)
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="account.md#0x1_account_initialize">initialize</a>(arx: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="account.md#0x1_account_initialize">initialize</a>(arx: &<a href="../../std/doc/signer.md#0x1_signer">signer</a>) {
    ...
    <b>move_to</b>(arx, <a href="account.md#0x1_account_OriginatingAddress">OriginatingAddress</a> {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="account.md#0x1_account_create_account">create_account</a>(new_address: <b>address</b>): <a href="../../std/doc/signer.md#0x1_signer">signer</a> {
    ...
    <b>assert</b>!(
        new_address != @vm_reserved && new_address != @arx,
...
<pre><code><b>fun</b> <a href="account.md#0x1_account_update_auth_key_and_originating_address_table">update_auth_key_and_originating_address_table</a>(
    ...
    <b>let</b> address_map = &<b>mut</b> <b>borrow_global_mut</b>&lt;<a href="account.md#0x1_account_OriginatingAddress">OriginatingAddress</a>&gt;(@arx).address_map;
...
In Arx a resource account is created based upon the sha3 256 of the source's address and
...
account, if found Arx will transition ownership of the account over to the resource account.
...
<a name="0x1_account_create_reserved_account"></a>

## Function `create_reserved_account`

create the account for system reserved addresses


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="account.md#0x1_account_create_reserved_account">create_reserved_account</a>(addr: <b>address</b>): (<a href="../../std/doc/signer.md#0x1_signer">signer</a>, <a href="account.md#0x1_account_SignerCapability">account::SignerCapability</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="account.md#0x1_account_create_reserved_account">create_reserved_account</a>(addr: <b>address</b>): (<a href="../../std/doc/signer.md#0x1_signer">signer</a>, <a href="account.md#0x1_account_SignerCapability">SignerCapability</a>) {
    <b>assert</b>!(
        addr == @0x1 ||
            addr == @0x2 ||
            addr == @0x3 ||
...
Only the address <code>@arx</code> can call.
OriginatingAddress does not exist under <code>@arx</code> before the call.
...
<b>aborts_if</b> <b>exists</b>&lt;<a href="account.md#0x1_account_OriginatingAddress">OriginatingAddress</a>&gt;(arx_addr);
<b>ensures</b> <b>exists</b>&lt;<a href="account.md#0x1_account_OriginatingAddress">OriginatingAddress</a>&gt;(arx_addr);
</code></pre>
...
Limit the new account address is not @vm_reserved / @arx.


<pre><code><b>include</b> <a href="account.md#0x1_account_CreateAccount">CreateAccount</a> {addr: new_address};
<b>aborts_if</b> new_address == @vm_reserved || new_address == @arx;
...
<b>modifies</b> <b>global</b>&lt;<a href="account.md#0x1_account_Account">Account</a>&gt;(addr);
<b>modifies</b> <b>global</b>&lt;<a href="account.md#0x1_account_OriginatingAddress">OriginatingAddress</a>&gt;(@arx);
</code></pre>
...
<a name="@Specification_1_create_reserved_account"></a>
