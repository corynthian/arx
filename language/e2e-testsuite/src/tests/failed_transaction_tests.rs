...
use arx_gas::{
    ArxGasMeter, ArxGasParameters, StorageGasParameters, LATEST_GAS_FEATURE_VERSION,
};
...
use arx_vm::{
    ...
    transaction_metadata::TransactionMetadata, ArxVM,
};
...
fn failed_transaction_cleanup_test() {
    ...
    let arx_vm = ArxVM::new(executor.get_state_view());
    ...
    let gas_params = ArxGasParameters::zeros();
    ...
    let out1 = arx_vm.failed_transaction_cleanup(
    ...
    let out2 = arx_vm.failed_transaction_cleanup(
