...
fn verify_signature() {
    ...
    let program = arx::arx_coin_transfer(*sender.address(), 100);
...
fn good_module_uses_bad(
    ...
    let framework_modules = arx_cached_packages::head_release_bundle().compiled_modules();
...
fn test_module_dependency_fails_verification() {
    ...
    let good_module = {
        ...
        arx_types::transaction::Module::new(serialized_module)
    };
...
fn test_module_transitive_dependency_fails_verification() {
    ...
    let module = {
        ...
        arx_types::transaction::Module::new(
            compiler
