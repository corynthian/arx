...
use crate::{ArxGasParameters, LATEST_GAS_FEATURE_VERSION};
use arx_types::{
...
impl StoragePricingV1 {
    fn new(gas_params: &ArxGasParameters) -> Self {
        Self {
...
impl StoragePricingV2 {
    ...
    fn calculate_write_set_gas<'a>(
        ...
        use arx_types::write_set::WriteOp::*;
...
impl ChangeSetConfigs {
    ...
    pub fn new(feature_version: u64, gas_params: &ArxGasParameters) -> Self {
    ...
    fn from_gas_params(gas_feature_version: u64, gas_params: &ArxGasParameters) -> Self {
        Self::new_impl(
            gas_feature_version,
