...
pub struct NativeGasParameters {
    ...
    pub arx_framework: arx_framework::natives::GasParameters,
...
impl FromOnChainGasSchedule for NativeGasParameters {
    fn from_on_chain_gas_schedule(
        ...
        Some(Self {
            ...
            arx_framework: FromOnChainGasSchedule::from_on_chain_gas_schedule(
                gas_schedule,
                feature_version,
            )?,
...
impl NativeGasParameters {
    pub fn zeros() -> Self {
        Self {
            ...
            arx_framework: arx_framework::natives::GasParameters::zeros(),
...
impl InitialGasSchedule for NativeGasParameters {
    fn initial() -> Self {
        Self {
            ...
            arx_framework: InitialGasSchedule::initial(),
            table: InitialGasSchedule::initial(),
        }
    }
}

/// Gas parameters for everything that is needed to run the Arx blockchain, including
/// instructions, transactions and native functions from various packages.
#[derive(Debug, Clone)]
pub struct ArxGasParameters {
...
impl FromOnChainGasSchedule for ArxGasParameters {
    fn from_on_chain_gas_schedule(
        gas_schedule: &BTreeMap<String, u64>,
        feature_version: u64,
    ) -> Option<Self> {
...
impl ToOnChainGasSchedule for ArxGasParameters {
    fn to_on_chain_gas_schedule(&self, feature_version: u64) -> Vec<(String, u64)> {
...
impl InitialGasSchedule for ArxGasParameters {
    fn initial() -> Self {
        Self {
...
/// The official gas meter used inside the Arx VM.
...
pub struct ArxGasMeter {
    feature_version: u64,
    gas_params: ArxGasParameters,
