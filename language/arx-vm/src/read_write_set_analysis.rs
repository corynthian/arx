...
impl<'a, R: MoveResolverExt> ReadWriteSetAnalysis<'a, R> {
    /// Create a Arx transaction read/write set analysis from a generic Move module read/write set
    ...
    fn get_concretized_keys_entry_function(
        ...
        // to do as of Arx 1.4, but should be re-evaluated if the epilogue changes
