...
Example (testing locally built CLI binary):
  python3 main.py --base-network devnet --test-cli-path ~/arx-core/target/release/arx

This means, run the CLI test suite using a CLI built from mainnet_0431e2251d0b42920d89a52c63439f7b9eda6ac3 against a local testnet built from the testnet branch of arx-core.
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="What branch the Arx CLI used for the local testnet should be built from",
    )
    parser.add_argument(
    ...
    test_cli_args.add_argument(
        "--test-cli-path",
        help="Path to CLI binary we want to test, e.g. /home/dport/arx-core/target/release/arx",
    )
    parser.add_argument(
        "--working-directory",
        default="/tmp/arx-cli-tests",
