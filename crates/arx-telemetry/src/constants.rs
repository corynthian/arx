...
pub(crate) const ENV_ARX_DISABLE_TELEMETRY: &str = "ARX_DISABLE_TELEMETRY";
pub(crate) const ENV_ARX_FORCE_ENABLE_TELEMETRY: &str = "ARX_FORCE_ENABLE_TELEMETRY";
pub(crate) const ENV_ARX_DISABLE_TELEMETRY_PUSH_METRICS: &str =
    "ARX_DISABLE_TELEMETRY_PUSH_METRICS";
pub(crate) const ENV_ARX_DISABLE_TELEMETRY_PUSH_LOGS: &str = "ARX_DISABLE_TELEMETRY_PUSH_LOGS";
pub(crate) const ENV_ARX_DISABLE_TELEMETRY_PUSH_EVENTS: &str =
    "ARX_DISABLE_TELEMETRY_PUSH_EVENTS";
pub(crate) const ENV_ARX_DISABLE_PROMETHEUS_NODE_METRICS: &str =
    "ARX_DISABLE_PROMETHEUS_NODE_METRICS";
pub(crate) const ENV_ARX_DISABLE_LOG_ENV_POLLING: &str = "ARX_DISABLE_LOG_ENV_POLLING";
...
// ARX-TODO: Rotate these periodically.
pub(crate) const ARX_GA_MEASUREMENT_ID: &str = "G-XX0X0XXXXX";
pub(crate) const ARX_GA_API_SECRET: &str = "333333333333";
...
// ARX-TODO: Change this
pub(crate) const TELEMETRY_SERVICE_URL: &str = "https://telemetry.arx.com";
pub(crate) const MAINNET_TELEMETRY_SERVICE_URL: &str = "https://telemetry.mainnet.arx.com";
