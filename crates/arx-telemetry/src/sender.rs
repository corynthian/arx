...
use arx_telemetry_service::types::{
    auth::{AuthRequest, AuthResponse},
    response::IndexResponse,
    telemetry::TelemetryDump,
};
use arx_types::{chain_id::ChainId, PeerId};
...
mod tests {
    ...
    use super::*;
    use crate::metrics::{ARX_TELEMETRY_SERVICE_FAILURE, ARX_TELEMETRY_SERVICE_SUCCESS};
    use arx_crypto::Uniform;
