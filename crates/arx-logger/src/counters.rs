...
pub static STRUCT_LOG_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!("arx_struct_log_count", "Count of the struct logs.").unwrap()
});
...
pub static PROCESSED_STRUCT_LOG_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "arx_struct_log_processed_count",
...
pub static STRUCT_LOG_QUEUE_ERROR_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "arx_struct_log_queue_error_count",
...
pub static STRUCT_LOG_PARSE_ERROR_COUNT: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "arx_struct_log_parse_error_count",
...
pub static ARX_LOG_INGEST_WRITER_FULL: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "arx_log_ingest_writer_full",
...
/// Counter for failed log ingest writes (see also: ol-telemetry for sender metrics)
pub static ARX_LOG_INGEST_WRITER_DISCONNECTED: Lazy<IntCounter> = Lazy::new(|| {
    register_int_counter!(
        "arx_log_ingest_writer_disconnected",
