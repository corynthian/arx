...
//!
//! ```
//! use arx_logger::{info, sample, sample::{SampleRate, Sampling}};
...
pub use crate::arx_logger::{
    ArxData as Logger, ArxDataBuilder, LoggerFilterUpdater, Writer, CHANNEL_SIZE,
};
pub use arx_log_derive::Schema;
pub use event::Event;
