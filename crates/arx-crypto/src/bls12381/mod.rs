...
//! ```
//! use std::iter::zip;
//! use arx_crypto::test_utils::{KeyPair, TestArxCrypto};
//! use arx_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use arx_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use arx_crypto::bls12381::ProofOfPossession;
//! use arx_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! use arx_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use arx_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use arx_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use arx_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use arx_crypto::validatable::Validatable;
//!
...
//! // signature on TestArxCrypto("test".to_owned())
...
//! ```
//! use std::iter::zip;
//! use arx_crypto::test_utils::KeyPair;
//! use arx_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use arx_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use arx_crypto::bls12381::ProofOfPossession;
//! use arx_crypto_derive::{CryptoHasher, BCSCryptoHash};
