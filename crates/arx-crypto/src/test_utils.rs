...
) -> impl Strategy<Value = (EdwardsPoint, EdwardsPoint, TestArxCrypto)> {
    (
...
pub struct TestArxCrypto(pub String);
...
// #[cfg(any(test, feature = "fuzzing"))]
pub struct TestArxCryptoHasher(crate::hash::DefaultHasher);
// #[cfg(any(test, feature = "fuzzing"))]
impl ::core::clone::Clone for TestArxCryptoHasher {
    #[inline]
    fn clone(&self) -> TestArxCryptoHasher {
        match *self {
            TestArxCryptoHasher(ref __self_0_0) => {
                TestArxCryptoHasher(::core::clone::Clone::clone(__self_0_0))
            },
        }
    }
}
...
// #[cfg(any(test, feature = "fuzzing"))]
impl TestArxCryptoHasher {
    fn new() -> Self {
        let name = crate::_serde_name::trace_name::<TestArxCrypto>()
            .expect("The `CryptoHasher` macro only applies to structs and enums");
        TestArxCryptoHasher(crate::hash::DefaultHasher::new(name.as_bytes()))
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
static TEST_CRYPTO_HASHER: crate::_once_cell::sync::Lazy<TestArxCryptoHasher> =
    crate::_once_cell::sync::Lazy::new(TestArxCryptoHasher::new);
// #[cfg(any(test, feature = "fuzzing"))]
impl std::default::Default for TestArxCryptoHasher {
    fn default() -> Self {
        TEST_CRYPTO_HASHER.clone()
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHasher for TestArxCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl std::io::Write for TestArxCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHash for TestArxCrypto {
    type Hasher = TestArxCryptoHasher;

    fn hash(&self) -> crate::hash::HashValue {
        use crate::hash::CryptoHasher;
        let mut state = Self::Hasher::default();
        bcs::serialize_into(&mut state, &self)
            .expect("BCS serialization of TestArxCrypto should not fail");
        state.finish()
    }
}

/// Produces a random TestArxCrypto signable / verifiable struct.
#[cfg(any(test, feature = "fuzzing"))]
pub fn random_serializable_struct() -> impl Strategy<Value = TestArxCrypto> {
    (String::arbitrary()).prop_map(TestArxCrypto).no_shrink()
}
