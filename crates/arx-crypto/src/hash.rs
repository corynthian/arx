...
//! use the derive macros of `serde` and `arx_crypto_derive` as follows:
//! ```
//! use arx_crypto::hash::CryptoHash;
...
//!
//! ```
//! use arx_crypto_derive::CryptoHasher;
...
//!
//! ```
//! use arx_crypto::hash::{CryptoHasher, TestOnlyHasher};
//!
...
pub(crate) const HASH_PREFIX: &[u8] = b"ARX::";
...
/// # Example
/// ```
/// use arx_crypto::hash::TestOnlyHash;
///
