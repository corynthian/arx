...
use crate::{
    ...
    test_utils::{TestArxCrypto, TEST_SEED},
    traits::*,
...
static MESSAGE: Lazy<TestArxCrypto> = Lazy::new(|| TestArxCrypto("Test Message".to_string()));
fn message() -> &'static TestArxCrypto {
    &MESSAGE
}
