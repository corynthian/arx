...
use arx_api_types::Transaction as APITransaction;
use arx_types::ARX_COIN_TYPE;
...
impl TransactionProcessor for CoinTransactionProcessor {
    ...
    async fn process_transactions(
        ...
        // get arx_coin info for supply tracking
        // TODO: This only needs to be fetched once. Need to persist somehow
        let maybe_arx_coin_info =
            &CoinInfoQuery::get_by_coin_type(ARX_COIN_TYPE.to_string(), &mut conn).unwrap();
        ...
        for txn in &transactions {
            let (
                ...
                current_coin_balances,
                mut coin_supply,
            ) = CoinActivity::from_transaction(txn, maybe_arx_coin_info);
