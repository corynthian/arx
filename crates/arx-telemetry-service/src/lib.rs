...
use arx_crypto::{x25519, ValidCryptoMaterialStringExt};
...
#[clap(name = "Arx Telemetry Service", author, version)]
pub struct ArxTelemetryServiceArgs {
    #[clap(short = 'f', long, parse(from_os_str))]
    config_path: PathBuf,
}

impl ArxTelemetryServiceArgs {
    pub async fn run(self) {
        ...
        let validators = Arc::new(arx_infallible::RwLock::new(HashMap::new()));
        let validator_fullnodes = Arc::new(arx_infallible::RwLock::new(HashMap::new()));
