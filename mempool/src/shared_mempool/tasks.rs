...
use anyhow::Result;
use arx_config::network_id::PeerNetworkId;
use arx_consensus_types::common::{RejectedTransactionSummary, TransactionSummary};
use arx_crypto::HashValue;
use arx_infallible::{Mutex, RwLock};
use arx_logger::prelude::*;
use arx_metrics_core::HistogramTimer;
use arx_network::application::interface::NetworkClientInterface;
use arx_storage_interface::state_view::LatestDbStateCheckpointView;
use arx_types::{
...
use arx_vm_validator::vm_validator::{get_account_sequence_number, TransactionValidation};
        ...
        QuorumStoreRequest::GetBatchRequest(max_txns, max_bytes, transactions, callback) => {
            ...
            let txns;
            {
...

                {
                    ...
                    let curr_time = arx_infallible::duration_since_epoch();
