...
use arx_config::{config::PeerSet, network_id::NetworkContext};
use arx_logger::info;
use arx_time_service::{Interval, TimeService, TimeServiceTrait};
use arx_types::{account_address::AccountAddress, on_chain_config::ValidatorSet};
...
pub struct RestStream {
    ...
    rest_client: arx_rest_client::Client,
...
impl RestStream {
    pub(crate) fn new(
        ...
        RestStream {
            network_context,
            rest_client: arx_rest_client::Client::new(rest_url),
