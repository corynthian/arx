...
pub fn peer_monitoring_service_network_config(
    ...
    NetworkServiceConfig::new(
        ...
        arx_channel::Config::new(max_network_channel_size)
...
impl NewNetworkEvents for PeerMonitoringServiceNetworkEvents {
    fn new(
        peer_manager_notification_receiver: arx_channel::Receiver<
            (PeerId, ProtocolId),
            PeerManagerNotification,
        >,
        connection_notification_receiver: arx_channel::Receiver<PeerId, ConnectionNotification>,
    ) -> Self {
