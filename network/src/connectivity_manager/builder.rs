...
pub struct ConnectivityManagerBuilder {
    ...
    conn_mgr_reqs_tx: arx_channel::Sender<ConnectivityRequest>,
}
...
impl ConnectivityManagerBuilder {
    pub fn create(
        ...
        let (conn_mgr_reqs_tx, conn_mgr_reqs_rx) = arx_channel::new(
            channel_size,
    ...
    pub fn conn_mgr_reqs_tx(&self) -> arx_channel::Sender<ConnectivityRequest> {
