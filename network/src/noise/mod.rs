...
//! We use Noise to secure connections between peers in Arx.
...
//!
//! ```
//! use arx_network::noise::{AntiReplayTimestamps, HandshakeAuthMode, NoiseUpgrader};
//! use futures::{executor, future, io::{AsyncReadExt, AsyncWriteExt}};
//! use arx_memsocket::MemorySocket;
//! use arx_config::{config::{Peer, PeerRole, RoleType}, network_id::{NetworkContext, NetworkId}};
//! use arx_crypto::{x25519, ed25519, Uniform, PrivateKey, test_utils::TEST_SEED};
...
//! [crypto]: ../arx_crypto/noise/index.html
