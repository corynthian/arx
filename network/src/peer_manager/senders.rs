...
pub struct PeerManagerRequestSender {
    inner: channel::Sender<(PeerId, ProtocolId), PeerManagerRequest>,
}
...
pub struct ConnectionRequestSender {
    inner: channel::Sender<PeerId, ConnectionRequest>,
}

impl PeerManagerRequestSender {
    /// Construct a new PeerManagerRequestSender with a raw channel::Sender
    pub fn new(inner: channel::Sender<(PeerId, ProtocolId), PeerManagerRequest>) -> Self {
        Self { inner }
    }
...
impl ConnectionRequestSender {
    /// Construct a new ConnectionRequestSender with a raw channel::Sender
    pub fn new(inner: channel::Sender<PeerId, ConnectionRequest>) -> Self {
        Self { inner }
    }
