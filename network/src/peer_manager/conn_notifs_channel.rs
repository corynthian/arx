...
pub type Sender = channel::Sender<PeerId, ConnectionNotification>;
pub type Receiver = channel::Receiver<PeerId, ConnectionNotification>;

pub fn new() -> (Sender, Receiver) {
    channel::new(QueueStyle::LIFO, 1, None)
}
