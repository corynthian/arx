...
//! Implementation of the unary RPC protocol as per [ArxNet wire protocol v1].
//!
//! ## Design:
//!
...
//!
//! [ArxNet wire protocol v1]:
//! https://github.com/diem/diem/blob/main/specifications/network/messaging-v1.md
...
impl InboundRpcs {
    ...
    pub fn handle_inbound_request(
        &mut self,
        peer_notifs_tx: &mut channel::Sender<ProtocolId, PeerNotification>,
        request: RpcRequest,
    ) -> Result<(), RpcError> {
