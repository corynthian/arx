...
struct TestHarness {
    ...
    peer_mgr_notifs_tx: arx_channel::Sender<(PeerId, ProtocolId), PeerManagerNotification>,
...
impl TestHarness {
    fn new_permissive(
        ...
        let (peer_mgr_reqs_tx, peer_mgr_reqs_rx) = arx_channel::new(QueueStyle::FIFO, 1, None);
