...
use arx_crypto::x25519::PublicKey;
...
use arx_netcore::transport::tcp::TCPBufferCfg;
use arx_network::{
...
use arx_network_discovery::DiscoveryChangeListener;
use arx_time_service::TimeService;
use arx_types::{chain_id::ChainId, network_address::NetworkAddress};
use std::{
    clone::Clone,
...
impl NetworkBuilder {
    ...
    pub fn conn_mgr_reqs_tx(&self) -> Option<arx_channel::Sender<ConnectivityRequest>> {
