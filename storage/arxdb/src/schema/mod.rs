...
//! This module defines representation of Arx core data structures at physical level via schemas
//! that implement [`arx_schemadb::schema::Schema`].
//!
...
use arx_schemadb::ColumnFamilyName;
...
#[cfg(feature = "fuzzing")]
pub mod fuzzing {
    use arx_schemadb::schema::fuzzing::assert_no_panic_decoding;
