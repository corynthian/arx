...
pub(crate) type LeafNode = arx_jellyfish_merkle::node_type::LeafNode<StateKey>;
pub(crate) type Node = arx_jellyfish_merkle::node_type::Node<StateKey>;
type NodeBatch = arx_jellyfish_merkle::NodeBatch<StateKey>;
