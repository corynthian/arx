...
use anyhow::Result;
use arx_types::nibble::{nibble_path::NibblePath, Nibble};
use clap::Parser;
...
impl DbDir {
    pub fn open_state_merkle_db(&self) -> Result<arx_schemadb::DB> {
        arx_schemadb::DB::open_cf_readonly(
    ...
    pub fn open_ledger_db(&self) -> Result<arx_schemadb::DB> {
        arx_schemadb::DB::open_cf_readonly(
            &arx_schemadb::Options::default(),
