...
use arx_config::config::StateMerklePrunerConfig;
use arx_infallible::Mutex;
use arx_jellyfish_merkle::StaleNodeIndex;
use arx_schemadb::{schema::KeyCodec, DB};
use arx_types::transaction::Version;
use std::{sync::Arc, thread::JoinHandle};

/// The `Pruner` is meant to be part of a `ArxDB` instance and runs in the background to prune old
/// data.
///
