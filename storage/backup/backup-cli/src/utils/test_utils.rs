...
pub fn tmp_db_empty() -> (TempPath, Arc<ArxDB>) {
    let tmpdir = TempPath::new();
    let db = Arc::new(ArxDB::new_for_test(&tmpdir));
...
pub fn start_local_backup_service(db: Arc<ArxDB>) -> (Runtime, u16) {
