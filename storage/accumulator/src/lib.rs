...
use arx_crypto::hash::{CryptoHash, CryptoHasher, HashValue, ACCUMULATOR_PLACEHOLDER_HASH};
use arx_types::proof::{
    ...
    H: CryptoHasher,
{
    ...
    ///
    /// See [`arx_types::proof::AccumulatorProof`] for proof format.
    pub fn get_proof(
        reader: &R,
    ...
    ///
    /// See [`arx_types::proof::AccumulatorConsistencyProof`] for proof format.
    ...
    ///
    /// See [`arx_types::proof::AccumulatorRangeProof`] for proof format.
