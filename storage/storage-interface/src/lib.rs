...
use arx_crypto::{hash::CryptoHash, HashValue};
use arx_types::{
...
impl From<arx_secure_net::Error> for Error {
    fn from(error: arx_secure_net::Error) -> Self {
        Self::ServiceError {
            error: format!("{}", error),
        }
    }
...
/// expected of an Arx DB
#[allow(unused_variables)]
pub trait DbReader: Send + Sync {
    /// See [ArxDB::get_epoch_ending_ledger_infos].
    ///
    /// [ArxDB::get_epoch_ending_ledger_infos]:
    /// ../arxdb/struct.ArxDB.html#method.get_epoch_ending_ledger_infos
    ...
    /// See [ArxDB::get_transactions].
    ///
    /// [ArxDB::get_transactions]: ../arxdb/struct.ArxDB.html#method.get_transactions
    fn get_transactions(
        &self,
    ...
    /// See [ArxDB::get_transaction_by_hash].
    ///
    /// [ArxDB::get_transaction_by_hash]: ../arxdb/struct.ArxDB.html#method.get_transaction_by_hash
    ...
    /// See [ArxDB::get_transaction_by_version].
    ///
    /// [ArxDB::get_transaction_by_version]: ../arxdb/struct.ArxDB.html#method.get_transaction_by_version
    ...
    /// See [ArxDB::get_first_txn_version].
    ///
    /// [ArxDB::get_first_txn_version]: ../arxdb/struct.ArxDB.html#method.get_first_txn_version
    fn get_first_txn_version(&self) -> Result<Option<Version>> {
        unimplemented!()
    }

    /// See [ArxDB::get_first_viable_txn_version].
    ///
    /// [ArxDB::get_first_viable_txn_version]: ../arxdb/struct.ArxDB.html#method.get_first_viable_txn_version
    fn get_first_viable_txn_version(&self) -> Result<Version> {
        unimplemented!()
    }

    /// See [ArxDB::get_first_write_set_version].
    ///
    /// [ArxDB::get_first_write_set_version]: ../arxdb/struct.ArxDB.html#method.get_first_write_set_version
    fn get_first_write_set_version(&self) -> Result<Option<Version>> {
        unimplemented!()
    }

    /// See [ArxDB::get_transaction_outputs].
    ///
    /// [ArxDB::get_transaction_outputs]: ../arxdb/struct.ArxDB.html#method.get_transaction_outputs
    ...
    /// See [ArxDB::get_block_timestamp].
    ///
    /// [ArxDB::get_block_timestamp]:
    /// ../arxdb/struct.ArxDB.html#method.get_block_timestamp
    ...
    /// See [ArxDB::get_state_value_by_version].
    ///
    /// [ArxDB::get_state_value_by_version]:
    /// ../arxdb/struct.ArxDB.html#method.get_state_value_by_version
    ...
    /// See [ArxDB::get_account_state_with_proof_by_version].
    ///
    /// [ArxDB::get_account_state_with_proof_by_version]:
    /// ../arxdb/struct.ArxDB.html#method.get_account_state_with_proof_by_version
    ///
    /// This is used by arx core (executor) internally.
...
impl MoveStorage for &dyn DbReader {
    ...
    fn fetch_config_by_version(&self, config_id: ConfigID, version: Version) -> Result<Vec<u8>> {
        ...
        config_value_option
            .map(|x| x.into_bytes())
            .ok_or_else(|| anyhow!("no config {} found in arx root account state", config_id))
    }
...
/// expected of an Arx DB. This adds write APIs to DbReader.
#[allow(unused_variables)]
pub trait DbWriter: Send + Sync {
    ...
    /// See [`ArxDB::save_transactions`].
    ///
    /// [`ArxDB::save_transactions`]: ../arxdb/struct.ArxDB.html#method.save_transactions
