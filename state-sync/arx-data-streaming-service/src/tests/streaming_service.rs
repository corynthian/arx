...
use crate::{
    ...
    tests::utils::{
        create_ledger_info, get_data_notification, initialize_logger, MockArxDataClient,
...
pub fn create_streaming_client_and_server(
    ...
    StreamingServiceClient,
    DataStreamingService<MockArxDataClient>,
) {
    initialize_logger();
    ...
    let arx_data_client_config = ArxDataClientConfig::default();
    let arx_data_client = MockArxDataClient::new(
