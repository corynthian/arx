...
use arx_data_client::{Response, ResponsePayload};
use arx_types::{
...
/// A request that has been sent to the Arx data client.
...
pub struct PendingClientResponse {
    ...
    pub client_response: Option<Result<Response<ResponsePayload>, arx_data_client::Error>>,
}
