...
use arx_config::config::StateSyncDriverConfig;
use arx_data_streaming_service::data_notification::NotificationId;
...
use arx_storage_interface::{DbReader, DbReaderWriter, StateSnapshotReceiver};
use arx_types::{
        ...
        while let Some(notification_id) = committer_listener.next().await {
            ...
            match result {
                Ok(notification) => {
                    ...
                    // storage. See: https://github.com/arx-labs/arx-core/issues/553
