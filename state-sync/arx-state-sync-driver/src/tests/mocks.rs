...
use arx_executor_types::{ChunkCommitNotification, ChunkExecutorTrait};
...
mock! {
    ...
    impl DataStreamingClient for StreamingClient {
        ...
        ) -> Result<DataStreamListener, arx_data_streaming_service::error::Error>;
        ...
        ) -> Result<(), arx_data_streaming_service::error::Error>;
    }
