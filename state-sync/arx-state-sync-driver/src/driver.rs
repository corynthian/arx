...
use arx_config::config::{RoleType, StateSyncDriverConfig};
use arx_consensus_notifications::{
    ConsensusCommitNotification, ConsensusNotification, ConsensusSyncNotification,
};
use arx_data_client::ArxDataClient;
use arx_data_streaming_service::streaming_client::{
...
impl<
        DataClient: ArxDataClient + Send + Clone + 'static,
