...
impl From<arx_data_streaming_service::error::Error> for Error {
    fn from(error: arx_data_streaming_service::error::Error) -> Self {
        Error::UnexpectedError(error.to_string())
    }
}

impl From<arx_event_notifications::Error> for Error {
    fn from(error: arx_event_notifications::Error) -> Self {
