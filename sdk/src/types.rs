...
/// LocalAccount represents an account on the Arx blockchain. Internally it
...
impl LocalAccount {
    ...
    /// does not actually create an account on the Arx blockchain, just a
    ...
    /// create an account on the Arx blockchain, it just generates a new
    /// account locally.
